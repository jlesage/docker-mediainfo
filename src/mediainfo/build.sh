...
log "Compiling MediaInfo CLI..."
make -C /tmp/MediaInfo/Project/GNU/CLI -j$(nproc)

log "Installing MediaInfo CLI..."
make DESTDIR=/tmp/mediainfo-install -C /tmp/MediaInfo/Project/GNU/CLI install
